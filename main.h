...
/**
 * struct parameters - this is the parameters struct
...
/* convert_number.c function prototype */
int print_hex(va_list ap, params_t *params);
int print_HEX(va_list ap, params_t *params);
int print_binary(va_list ap, params_t *params);
int print_octal(va_list ap, params_t *params);

/* simple_printers.c function prototype */
int print_from_to(char *start, char *stop, char *except);
int print_rev(va_list ap, params_t *params);
int print_rot13(va_list ap, params_t *params);

/* print_number.c function prototype */
int _isdigit(int c);
int _strlen(char *s);
...
/* params.c function prototype */
void init_params(params_t *params, va_list ap);

/* string_fields.c function prototype */
char *get_precision(char *p, params_t *params, va_list ap);

/* _prinf.c function prototype */
